...
# TEST PARAMETERS
TP = sum((lr.predict(rtrain.CO2.values.reshape(-1, 1)) == rtrain.Occupancy) & (lr.predict(rtrain.CO2.values.reshape(-1, 1)) == 1))
TN = sum((lr.predict(rtrain.CO2.values.reshape(-1, 1)) == rtrain.Occupancy) & (lr.predict(rtrain.CO2.values.reshape(-1, 1)) == 0))
FP = sum((lr.predict(rtrain.CO2.values.reshape(-1, 1)) != rtrain.Occupancy) & (lr.predict(rtrain.CO2.values.reshape(-1, 1)) == 1))
FN = sum((lr.predict(rtrain.CO2.values.reshape(-1, 1)) != rtrain.Occupancy) & (lr.predict(rtrain.CO2.values.reshape(-1, 1)) == 0))
...
FP = sum((lr.predict(rdev.CO2.values.reshape(-1, 1)) != rdev_expected['y']) & (lr.predict(rdev.CO2.values.reshape(-1, 1)) == 1))
